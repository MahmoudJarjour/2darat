import { Card, Container, Grid, CardContent, Typography, Accordion, AccordionSummary, AccordionDetails } from '@material-ui/core';
	...
	return (
		<Grid container spacing={2}>
			<Grid item xs={12}>
				<Card>
					<CardContent>
						<Typography>إدارات الدولة اللبنانية</Typography>
					</CardContent>
				</Card>
			</Grid>

			<ChartView title="lebanon" data={data} />
		</Grid>
	);
}
